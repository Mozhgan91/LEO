...
from leo.model.leo_chat import LeoConfig, LeoModel
...
def split_model(num_layers, vit_alpha=0.5):
    ...
    for i, num_layer in enumerate(num_layers_per_gpu):
        for j in range(num_layer):
            ...
            layer_cnt += 1
    device_map['vision_model_1'] = 0
    device_map['mlp1'] = 0
    device_map['vision_model_2'] = 0
    device_map['mlp2'] = 0
...
def load_model_and_tokenizer(args):
    ...
    if args.auto:
        config = HybridConfig.from_pretrained(args.checkpoint)
